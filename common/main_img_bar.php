<div class="slideshow">
    <div class="slideshow_slides">
        ...
        <a href="#"><img src="http://<?=$_SERVER["HTTP_HOST"]?>/project_highschool/common/img/winter-1.jpg" alt="겨울"></a>
    </div>

    <!-- 슬라이드 좌우 네비게이션 -->
    <div class="slideshow_nav">
            <a href="#" class="prev prev_next">prev</a>
            <a href="#" class="next prev_next">next</a>
    </div>
