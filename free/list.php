...
<html lang="ko" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/php_practice/0420homework/free/css/greet.css">
		<script type="text/javascript" src="http://<?= $_SERVER["HTTP_HOST"] ?>/project_highschool/free/js/member_form.js" defer></script>
	</head>
	<body>
		<header>
