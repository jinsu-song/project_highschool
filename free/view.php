<?php
    ...
    include $_SERVER['DOCUMENT_ROOT'] . "/project_highschool/free/lib/free_func.php";
...
<html lang="ko" dir="ltr">
	<head>
		...
		<link rel="stylesheet" type="text/css"
		      href="http://<?= $_SERVER['HTTP_HOST'] ?>/project_highschool/free/css/greet.css">
	...
	<body onload="slide_func()">
		...
		<section>
			...
			");
                ...
                include $_SERVER['DOCUMENT_ROOT'] . "/project_highschool/common/main_img_bar.php"; ?>
			<div id="wrap">
				<div id="content">
					<div id="col2">
                      ...
                      ");
						...
						<div id="write_button">
							<a href="./free_list.php?page=<?= $page ?>"><img src="./img/list.png"></a>
